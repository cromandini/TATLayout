...
## Installation
TATLayout will be available through [CocoaPods](http://cocoapods.org), but it's not yet released. To install it, clone the repo and add the following line to your Podfile:

```ruby
pod 'TATLayout', :path => '~/path/to/TATLayout'
```
