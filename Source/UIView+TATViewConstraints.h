...
/**
 ...
 @param format The format specification for the constraint. Since the first item is automatically set to be the receiver, the equation format must start from the first attribute, example `width == superview.width` translates to `self.width == superview.width`. Also, if you want the second item to be the receiver you can do so by using the keyword `self`, example `width == self.height`.
...
/**
 ...
 @param formats The format specifications for the constraints. Since the first item is automatically set to be the receiver, the equation format must start from the first attribute, example `width == superview.width` translates to `self.width == superview.width`. Also, if you want the second item to be the receiver you can do so by using the keyword `self`, example `width == self.height`.
